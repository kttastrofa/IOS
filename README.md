...
Implementační detaily
    ...
    Skript musí běžet na běžně dostupných OS GNU/Linux, BSD a MacOS. V průběhu projektu Vám bude poskytnut virtuální stroj, na kterém lze ověřit správnou funkčnost projektu.
